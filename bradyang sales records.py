...
print("The profit per Unit in the Fruit Category is %f" % FruitUnits_Total)
print("The profit per Unit in the Household category is %f" % HouseholdUnits_Total)
print("The profit per Unit in the Office Supply category is %f" % OfficeSuppliesUnits_Total)
print("The profit per Unit in the Clothes Category is %f" % ClothesUnits_Total)
print("The profit per Unit in the Meat Category is %f" % MeatUnits_Total)
print("The profit per unit in the Beverage category is %f" % BeveragesUnits_Total)
print("The profit per unit in the Cosmetics category is %f" % CosmeticsUnits_Total)
print("The profit per unit in the Personal Care Category is %f" % PersonalCareUnits_Total)
print("The profit per unit in the Baby Food Category is %f" % BabyFoodUnit_Total)
print("The profit of Money per unit in the Cereal Category is %f" % CerealUnit_Total)
print("The profit per unit in the Veggies Category is %f" % VeggiesUnits_Total)
print("The profit per unit in the Snacks Category is %f" % SnacksUnit_Total)
print()
print()
print("THE  PROFIT THE FRUIT CATEGORY IS %f" % Fruit_Sum)
print("THE PROFIT THE HOUSEHOLD CATEGORY IS %f" % Household_sum)
print("THE PROFIT THE OFFICE SUPPLY CATEGORY IS %f" % Office_Supplies_sum)
print("THE  PROFIT THE CLOTHES CATEGORY IS %f" % Clothes_sum)
print("THE PROFIT THE MEAT CATEGORY IS %f" % Meat_sum)
print("The profit the beverage category has is %f" % Beverages_sum)
print("The profit that the Cosmetics Category made is %f" % Cosmetics_sum)
print("The profit the Personal Care category made is %f" % Personal_Care_sum)
print("The the Baby Food category made is %f" % Baby_Food_sum)
print("The the Cereal Category made is %f" % Cereal_sum)
print("The the Vegetables category made is %f" % Veggies_sum)
print("The Snacks Category made is %f" % Snacks_sum)
print("AND The Category with the most profit is %f " % ItemCategoryType[index])
print()
print()
...
print("AND the Region with the Most amount of profit is %f " % RegionProfitSum[index])
print("Done")
